...
export const LoginPage: React.FC<LoginPageProps> = memo(() => {
    ...
    return (
        <PageWrapper breadcrumbs={[UrlConfig.main, UrlConfig.auth.login]} className="flex items-center justify-center">
            <AuthCard>
                <CardHeader>
                ...
                <CardFooter>
                    <Muted>
                        Немає акаунту?{' '}
                        <Link to={UrlConfig.auth.register.url} className="underline">
                            Зареєструватись
                        </Link>
                    </Muted>
                </CardFooter>
